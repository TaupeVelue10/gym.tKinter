...
with flask_app.app_context():
    ...
    # Render template with the computed program_days and debug_prog
    from flask import render_template
    with flask_app.test_request_context('/generate?days=3'):
        html = render_template('program.html', program=program_days, debug_prog=repr(programme_by_session))
    print(html)
